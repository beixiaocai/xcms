...
(function() {
    ...
    function loadFormData(data, mode) {
        ...
        if (mode === 'add') {
            ...
            // 重置模式三配置
            $('#m3ClassifyInputIsBg').val('0');
            $('#m3ClassifyOutputIsCover').val('1');
            
            // 重置模式八配置
            $('#m8Detect2InputIsBg').val('1');
            $('#m8m9Type').val('0');
            
            // 重置模式九配置
            $('#m8m9Type_mode9').val('0');
            ...
            // 加载模式三配置
            $('#m3ClassifyInputIsBg').val(String(flow.m3_classify_input_is_bg !== undefined && flow.m3_classify_input_is_bg !== null ? flow.m3_classify_input_is_bg : 0));
            $('#m3ClassifyOutputIsCover').val(String(flow.m3_classify_output_is_cover !== undefined && flow.m3_classify_output_is_cover !== null ? flow.m3_classify_output_is_cover : 1));
            
            // 加载模式八配置
            $('#m8Detect2InputIsBg').val(String(flow.m8_detect2_input_is_bg !== undefined && flow.m8_detect2_input_is_bg !== null ? flow.m8_detect2_input_is_bg : 1));
            $('#m8m9Type').val(String(flow.m8m9_type !== undefined && flow.m8m9_type !== null ? flow.m8m9_type : 0));
            
            // 加载模式九配置
            $('#m8m9Type_mode9').val(String(flow.m8m9_type !== undefined && flow.m8m9_type !== null ? flow.m8m9_type : 0));
    ...
    window.submitFlowForm = function() {
        ...
        // 获取m8m9_type值（根据模式选择不同的字段）
        let m8m9TypeValue = '0';
        if (mode === 8) {
            m8m9TypeValue = $('#m8m9Type').val();
        } else if (mode === 9) {
            m8m9TypeValue = $('#m8m9Type_mode9').val();
        }
        ...
        const data = {
            ...
            m3_classify_input_is_bg: $('#m3ClassifyInputIsBg').val(),
            m3_classify_output_is_cover: $('#m3ClassifyOutputIsCover').val(),
            m8_detect2_input_is_bg: $('#m8Detect2InputIsBg').val(),
            m8m9_type: m8m9TypeValue
